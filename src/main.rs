...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let influx_url = "http://localhost:8086/api/v2/write?org=greista&bucket=tetetoken&precision=s";
    let token = "eIQ0DQtFjWrxfQYiCe7N00yn4ax8DKtvtyZ2czYyRABALgWgoWh57Nv_Zux7NkI7aRLV4U2UCsUuzBLlxtIpMA==";
